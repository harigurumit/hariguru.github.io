    ...
    <footer className="bg-secondary/50 mt-16">
      <div className="container mx-auto py-6 px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center">
        ...
        <div className="flex space-x-6">
          ...
          <SocialIcon href={socials.googleScholar}>
             <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 24a7 7 0 1 1 0-14 7 7 0 0 1 0 14zm0-24L0 6v5.223l12 6.09L24 11.223V6L12 0z"/></svg>
          </SocialIcon>
        </div>
      </div>
    </footer>
